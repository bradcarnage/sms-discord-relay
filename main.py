...
class MessageParser(object):
    """CONVERSION FROM JAVASCRIPT TO PYTHON (STOLEN FROM WEBUI)
    these functions do some weird sh*t with GSM encoding and decoding messages.
    i'm not one to mess with it, thank you very much, original developers."""
    def __init__(self):
